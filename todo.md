...
- [ ] **Emergency contact on OpenApply** — Nana flagged it outstanding 20 Aug; due today 23 Aug. Confirm it was submitted.
...
- [ ] **Hopes & Dreams forms** — Complete before Fri 28 Aug (Malte 08:15, Vega-Lo 08:45, Eldor 09:15).
...
- [ ] **PYP Choir for Malte** — Optional. Permission slip to Yui by Fri 5 Sep.
...
- [x] Class placements + homeroom teachers captured from Toddle (21 Aug 2026) and written into memory.md (23 Aug 2026)
- [x] `resend_briefing.py` accepts repeated `--to` / `--cc` and sends a `User-Agent` (23 Aug 2026)
